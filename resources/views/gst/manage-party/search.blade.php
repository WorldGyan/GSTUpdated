    ...
    <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <i class="fa fa-align-justify"></i> Party Detail
          </div>
                ...
                <tr>
                  ...
                  <td>
                   <a href="{{ url('/')}}/gst/manage-party/add/{{ $value['id'] }}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a> 
                      <a href="{{ url('/')}}/gst/manage-party/trash/{{ $value['id']}} " class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete this user?');"><i class="fa fa-remove"></i></a>
                  </td>
                </tr>  
                @endforeach
              </tbody>
